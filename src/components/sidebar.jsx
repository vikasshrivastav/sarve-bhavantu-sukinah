        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Sarve Bhavantu Sukhinah Organisation</a></h1>
              <span className="email"><i className="icon-mail"></i> sbsfoundation2020@gmail.com</span>
            </div>
